...
class TestListCommandIntegration:
    ...
    def test_list_command_filter_by_type(self, temp_claude_dir, sample_settings, monkeypatch, capsys):
    ...
    def test_list_command_filter_pattern(self, temp_claude_dir, sample_settings, monkeypatch, capsys):
