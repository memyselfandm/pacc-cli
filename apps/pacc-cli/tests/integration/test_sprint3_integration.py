...
class TestSprint3Integration:
    ...
    def test_cli_parser_includes_plugin_commands(self):
        ...
        args = parser.parse_args(['plugin', 'remove', 'test-plugin', '--repo', 'owner/repo', '--force'])
        assert args.command == 'plugin'
    ...
    def test_config_validation_structure(self):
        ...
        config = {
            ...
            "version": "1.0.0",
            "plugins": {
                "repositories": ["team/productivity-tools@v1.1.0"]
            }
        }
    ...
    def test_performance_validation_large_config(self):
        ...
        config = {
            ...
            "plugins": {
                "repositories": [
                    f"org/repo-{i}@v1.0.0" for i in range(10)
                ],
...
class TestSprint3EdgeCases:
    ...
    def test_environment_specific_config(self):
        ...
        config = {
            ...
            "version": "1.0.0",
            "plugins": {
                "repositories": ["base/repo@v1.0.0"]
            },
            "environments": {
                "development": {
                    "plugins": {
                        "repositories": ["dev/tools@latest"]
                    }
                },
                "production": {
                    "plugins": {
                        "repositories": ["prod/stable@v2.0.0"]
                    }
                }
            }
        }
