...
from pacc.plugins.creator import PluginCreator, CreationPluginType, CreationMode
from pacc.plugins.search import search_plugins, get_plugin_recommendations, SearchResult, SearchPluginType
...
class TestSprintSixIntegration:
    ...
    def test_create_and_search_workflow_integration(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('pacc.plugins.search.LocalPluginIndex.get_installed_plugins') as mock_installed:
    ...
    def test_search_engine_with_created_plugins(self):
        ...
        with patch('pacc.plugins.search.PluginRegistry.search_community_plugins') as mock_community:
            with patch('pacc.plugins.search.LocalPluginIndex.get_installed_plugins') as mock_local:
                ...
                mock_local.return_value = [hook_plugin, agent_plugin]  # hook and agent plugins installed
...
class TestSprintSixPerformance:
    ...
    def test_search_performance_with_large_dataset(self):
        ...
        mock_plugins = []
        for i in range(100):
            plugin_types = [SearchPluginType.HOOK, SearchPluginType.AGENT, SearchPluginType.COMMAND, SearchPluginType.MCP]
            mock_plugins.append(SearchResult(
                name=f"plugin-{i:03d}",
