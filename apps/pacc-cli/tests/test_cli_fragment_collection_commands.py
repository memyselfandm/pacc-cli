...
""")
    ...
    def test_fragment_discover_with_metadata(self):
        ...
        with patch('sys.argv', ['pacc', 'fragment', 'discover', str(self.temp_dir), '--show-metadata']):
            result = self.cli.main()
    ...
    def test_fragment_discover_json_format(self):
        ...
        with patch('sys.argv', ['pacc', 'fragment', 'discover', str(self.temp_dir), '--format', 'json']):
            result = self.cli.main()
    ...
    def test_fragment_discover_yaml_format(self):
        ...
        with patch('sys.argv', ['pacc', 'fragment', 'discover', str(self.temp_dir), '--format', 'yaml']):
            result = self.cli.main()
    ...
    def test_fragment_collection_install_dry_run(self):
        ...
        with patch('sys.argv', [
            'pacc', 'fragment', 'install-collection', str(collection_dir),
            '--dry-run'
        ]):
            result = self.cli.main()
    ...
    def test_fragment_collection_install_nonexistent_source(self):
        ...
        with patch('sys.argv', [
            'pacc', 'fragment', 'install-collection', str(nonexistent_path)
        ]):
            result = self.cli.main()
    ...
    def test_fragment_collection_install_file_source(self):
        ...
        with patch('sys.argv', [
            'pacc', 'fragment', 'install-collection', str(file_path)
        ]):
            result = self.cli.main()
    ...
    def test_fragment_collection_status_filter_by_storage(self):
        ...
        with patch('sys.argv', ['pacc', 'fragment', 'collection-status', '--storage-type', 'project']):
            result = self.cli.main()
    ...
    def test_fragment_collection_update_nonexistent(self):
        ...
        with patch('sys.argv', [
            'pacc', 'fragment', 'update-collection', 'nonexistent-collection', str(collection_dir)
        ]):
            result = self.cli.main()
    ...
    def test_fragment_collection_remove_force(self):
        ...
        with patch('sys.argv', [
            'pacc', 'fragment', 'remove-collection', 'test-collection', '--force'
        ]):
            result = self.cli.main()
    ...
    def test_fragment_collection_remove_with_dependencies(self):
        ...
        with patch('sys.argv', [
            'pacc', 'fragment', 'remove-collection', 'test-collection',
            '--remove-dependencies', '--force'
        ]):
            result = self.cli.main()
...
class TestFragmentCollectionErrorHandling:
    ...
    def test_collection_manager_import_error(self):
        ...
        with patch('pacc.fragments.collection_manager.FragmentCollectionManager', side_effect=ImportError("Module not found")):
            with patch('sys.argv', ['pacc', 'fragment', 'discover', str(self.temp_dir)]):
                result = self.cli.main()
    ...
    def test_collection_install_exception(self):
        ...
        with patch('pacc.fragments.collection_manager.FragmentCollectionManager.install_collection', 
    ...
    def test_collection_status_exception(self):
        ...
        with patch('pacc.fragments.collection_manager.FragmentCollectionManager.list_collections_with_metadata',
    ...
    def test_collection_update_exception(self):
        ...
        with patch('pacc.fragments.collection_manager.FragmentCollectionManager.update_collection',
    ...
    def test_collection_remove_exception(self):
        ...
        with patch('pacc.fragments.collection_manager.FragmentCollectionManager.remove_collection',
