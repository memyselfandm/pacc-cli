...
""")
    ...
    def test_discover_fragments_with_pacc_json_specification(self, tmp_path):
        ...
        memories_dir.mkdir()
        (memories_dir / "important-notes.md").write_text(
...
""")
        ...
        fragment_with_warnings = next(
            f for f in repo_info.fragments if f.name == "invalid-fragment"
        )
        ...
        assert (
            "empty" in fragment_with_warnings.warnings[0].lower()
            or "title" in fragment_with_warnings.warnings[0].lower()
        )
    ...
    def test_fragment_caching(self, tmp_path):
        ...
        for i in range(5):
            (fragments_dir / f"fragment-{i}.md").write_text(
    ...
    def test_fragment_collection_creation(self, tmp_path):
        ...
        collection_info = type(
            ...
            (),
            {
                ...
                "metadata": {"description": "API Documentation Collection", "fragment_count": 2},
                "errors": [],
            },
        )()
...
class TestRepositoryInfoFragmentExtensions:
    ...
    def test_repository_info_fragment_properties(self, tmp_path):
        ...
        mock_fragment = type(
            "FragmentInfo",
            (),
            {"name": "test-fragment", "is_valid": True, "errors": [], "warnings": []},
        )()
