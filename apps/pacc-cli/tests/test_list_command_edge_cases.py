...
class TestListCommandEdgeCases:
    ...
    def test_list_extensions_with_missing_metadata(self, cli, mock_config_manager, capsys):
        ...
        lines = captured.out.split('\n')
        assert any(line.strip().startswith("|") or "unnamed" in line or "" in line for line in lines)
    
    # Edge case: Extremely long extension names and descriptions
    def test_list_extensions_with_long_names_and_descriptions(self, cli, mock_config_manager, capsys):
