...
from pacc.plugins.marketplace import (
    SemanticVersion, PluginDependency, PluginReview, PluginVersion,
    PluginMetadata, RegistryConfig, MetadataCache, DependencyResolver,
    MarketplaceClient, RegistryType, PluginStatus, DependencyConstraint,
    CacheEntry
)
...
class TestPluginMetadata:
    ...
    def create_sample_plugin_metadata(self):
        ...
        versions = [
            ...
            PluginVersion("0.9.0", datetime(2024, 12, 1), is_yanked=True, yank_reason="Security issue")
        ]
...
class TestRegistryConfig:
    ...
    def test_auth_headers(self):
        ...
        api_registry = RegistryConfig(
            "test", "https://api.example.com", RegistryType.PRIVATE,
        ...
        public_registry = RegistryConfig(
            "test", "https://api.example.com", RegistryType.PUBLIC
        )
    ...
    def test_config_serialization(self):
        ...
        registry = RegistryConfig(
            "test", "https://api.example.com", RegistryType.PRIVATE,
            api_key="secret", password="secret-pass"
        )
...
class TestMarketplaceClient:
    ...
    def test_config_persistence(self):
        ...
        # Add registry
        registry = RegistryConfig(
            "test-registry", "https://test.com", RegistryType.PUBLIC
        )
    ...
    def test_mock_plugin_metadata_retrieval(self, mock_path):
        ...
        mock_registry_file.open.return_value.__enter__.return_value.read.return_value = json.dumps(mock_registry_data)
