...
class TestPluginSyncCLI:
    ...
    def test_handle_plugin_sync_success(self, mock_sync_manager_class):
        ...
        # Mock print methods
        with patch.object(self.cli, '_print_success') as mock_success, \
             patch.object(self.cli, '_print_info') as mock_info, \
    ...
    def test_handle_plugin_sync_failure(self, mock_sync_manager_class):
        ...
        # Mock print methods
        with patch.object(self.cli, '_print_error') as mock_error, \
             patch.object(self.cli, '_print_warning') as mock_warning, \
             patch.object(self.cli, '_set_json_mode'):
    ...
    def test_handle_plugin_sync_dry_run(self, mock_sync_manager_class):
        ...
        with patch.object(self.cli, '_print_info') as mock_info, \
             patch.object(self.cli, '_print_success'), \
             patch.object(self.cli, '_set_json_mode'):
            ...
            dry_run_mentioned = any("dry-run" in call.lower() or "dry run" in call.lower() for call in info_calls)
    ...
    def test_handle_plugin_sync_json_output(self, mock_sync_manager_class):
        ...
        with patch('builtins.print') as mock_print, \
             patch.object(self.cli, '_set_json_mode'), \
             patch.object(self.cli, '_print_success'), \
             patch.object(self.cli, '_print_info'):
    ...
    def test_handle_plugin_sync_with_warnings(self, mock_sync_manager_class):
        ...
        mock_sync_result = PluginSyncResult(
            success=True,
            warnings=["Plugin foo is deprecated", "Version conflict resolved"]
        )
        mock_sync_manager.sync_plugins.return_value = mock_sync_result
        mock_sync_manager_class.return_value = mock_sync_manager
        ...
        with patch.object(self.cli, '_print_warning') as mock_warning, \
             patch.object(self.cli, '_print_success'), \
             patch.object(self.cli, '_print_info'), \
             patch.object(self.cli, '_set_json_mode'):
