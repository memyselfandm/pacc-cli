...
from pacc.cli import PACCCli, Extension
from pacc.core.config_manager import ClaudeConfigManager
from pacc.errors.exceptions import ConfigurationError, PACCError
...
class TestRemoveCommandDependencyChecking:
    ...
    def test_find_dependencies_multiple(self):
        ...
        config = {
            ...
            "mcps": [
                {"name": "mcp_dep", "path": "mcps/mcp.py", "dependencies": ["base_hook"]}
            ],
            "agents": [],
            "commands": []
        }
    ...
    def test_find_dependencies_cross_type(self):
        ...
        config = {
            "hooks": [
                {"name": "base_extension", "path": "hooks/base.json"}
            ],
            "mcps": [
                {"name": "mcp1", "path": "mcps/mcp1.py", "dependencies": ["base_extension"]}
            ],
            "agents": [
