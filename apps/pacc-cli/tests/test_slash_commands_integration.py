...
class TestSlashCommandsIntegration:
    ...
    def test_slash_command_files_structure(self):
        ...
        slash_commands = ["install", "list", "search", "info", "update", "remove"]
    ...
    def _create_test_slash_commands(self):
        ...
        real_commands_dir = (
            Path(__file__).parent.parent.parent.parent / ".claude" / "commands" / "pacc"
        )
...
class TestSlashCommandContent:
    ...
    def test_install_command_variations(self):
        ...
        test_cases = [
            ...
            (
                "./local/extension.json --type hooks",
                ["install", "./local/extension.json", "--type", "hooks"],
            ),
    ...
    def test_install_list_remove_workflow(self):
        ...
        install_result = {
            ...
            "data": {
                "installed_count": 1,
                "extensions": [
                    {"name": "test-hook", "type": "hook", "description": "Test hook extension"}
                ],
            },
        }
        ...
        remove_result = {
            ...
            "data": {
                "removed_extension": {"name": "test-hook", "type": "hook", "scope": "project"}
            },
        }
