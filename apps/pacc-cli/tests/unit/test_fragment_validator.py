...
"""
    ...
    def test_validate_valid_fragment_with_frontmatter(self, validator, valid_fragment_content, temp_dir):
    ...
    def test_validate_valid_fragment_no_frontmatter(self, validator, fragment_no_frontmatter, temp_dir):
...
"""
            ...
            if expected_code:
                ...
                title_issues = [issue for issue in result.all_issues 
                              if "title" in issue.message.lower()]
...
""",
        ...
        security_warnings = [w for w in security_result.warnings if w.code == "POTENTIAL_SECURITY_ISSUE"]
        assert len(security_warnings) > 0
    ...
    def test_directory_validation_integration(self, validator, temp_dir):
        ...
        (fragments_dir / "fragment2.md").write_text("# Fragment 2\n\nSimple fragment without frontmatter.")
