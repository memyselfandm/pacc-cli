...
from pacc.fragments.version_tracker import FragmentVersion, FragmentVersionTracker
...
class TestFragmentVersionTracker:
    ...
    def test_track_installation_git(self, mock_run, temp_project):
        ...
        version = tracker.track_installation(
            "test_fragment", "https://github.com/test/repo.git", "git", fragment_path
        )
    ...
    def test_track_installation_url(self, temp_project):
        ...
        version = tracker.track_installation(
            "test_fragment", "https://example.com/fragment.md", "url", fragment_path
        )
    ...
    def test_get_version(self, temp_project):
        ...
        # Add a version
        version = FragmentVersion(
            version_id="abc12345", source_type="git", timestamp=datetime.now()
        )
    ...
    def test_update_version(self, temp_project):
        ...
        new_version = FragmentVersion(
            version_id="def67890", source_type="git", timestamp=datetime.now()
        )
