...
from pacc.validators.base import BaseValidator, ValidationError, ValidationResult
...
class TestValidationError:
    ...
    def test_str_with_file(self):
        ...
        error = ValidationError(
            code="TEST_ERROR", message="Test message", file_path="/test/file.json"
        )
    ...
    def test_str_with_line_number(self):
        ...
        error = ValidationError(
            code="TEST_ERROR", message="Test message", file_path="/test/file.json", line_number=42
        )
    ...
    def test_str_with_suggestion(self):
        ...
        error = ValidationError(
            code="TEST_ERROR", message="Test message", suggestion="Fix this issue"
        )
    ...
    def test_str_severity_cases(self):
        ...
        for severity in ["error", "warning", "info"]:
            error = ValidationError(code="TEST_ERROR", message="Test message", severity=severity)
...
class TestValidationResult:
    ...
    def test_add_error(self):
        ...
        result.add_error(
            code="TEST_ERROR", message="Test error message", line_number=10, suggestion="Fix this"
        )
    ...
    def test_add_error_override_file_path(self):
        ...
        result.add_error(code="TEST_ERROR", message="Test error", file_path="/override/file.json")
    ...
    def test_add_warning(self):
        ...
        result.add_warning(
            code="TEST_WARNING", message="Test warning message", suggestion="Consider fixing"
        )
    ...
    def test_add_info(self):
        ...
        result.add_info(code="TEST_INFO", message="Test info message")
...
class TestBaseValidator:
    ...
    def test_validate_field_type_missing_required(self, mock_validator):
        ...
        error = mock_validator._validate_field_type(
            data, "version", str, "/test/file.json", required=True
        )
    ...
    def test_validate_field_type_missing_optional(self, mock_validator):
        ...
        error = mock_validator._validate_field_type(
            data, "description", str, "/test/file.json", required=False
        )
